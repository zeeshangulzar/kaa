namespace :resque do
  task :restart do
    ...
    system("(cd #{Dir.pwd} && nohup nice -5 bundle exec rake environment resque:work RAILS_ENV=production QUEUE=default PIDFILE=./resque.pid >> 'log/resque.log' 2>&1 &) && sleep 1")
    puts "Should be up."
  end
end
