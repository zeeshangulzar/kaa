...
class CustomContent < ApplicationModel
  ...
  attr_privacy :promotion_id, :location_id, :category, :key, :group, :title_html, :title, :description_html, :summary_html, :content_html, :content, :image1, :image2, :caption_html, :sequence, :public
